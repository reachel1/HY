...
add_executable(rpe_estimate src/rpe_estimate.cpp)
target_link_libraries(rpe_estimate ov_eval_lib ${thirdparty_libraries})
install(TARGETS rpe_estimate
        LIBRARY         DESTINATION ${CMAKE_INSTALL_LIBDIR}
        RUNTIME         DESTINATION ${CMAKE_INSTALL_BINDIR}
        PUBLIC_HEADER   DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}
)

add_executable(align_error src/apeandrpe_for_aligntraj.cpp)
target_link_libraries(align_error ov_eval_lib ${thirdparty_libraries})
install(TARGETS align_error
        LIBRARY         DESTINATION ${CMAKE_INSTALL_LIBDIR}
        RUNTIME         DESTINATION ${CMAKE_INSTALL_BINDIR}
        PUBLIC_HEADER   DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}
)

add_executable(error_alignrun src/error_alignrun.cpp)
target_link_libraries(error_alignrun ov_eval_lib ${thirdparty_libraries})
install(TARGETS error_alignrun
        LIBRARY         DESTINATION ${CMAKE_INSTALL_LIBDIR}
        RUNTIME         DESTINATION ${CMAKE_INSTALL_BINDIR}
        PUBLIC_HEADER   DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}
)

add_executable(alignape_estimate src/alignape_estimate.cpp)
target_link_libraries(alignape_estimate ov_eval_lib ${thirdparty_libraries})
install(TARGETS alignape_estimate
        LIBRARY         DESTINATION ${CMAKE_INSTALL_LIBDIR}
        RUNTIME         DESTINATION ${CMAKE_INSTALL_BINDIR}
        PUBLIC_HEADER   DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}
)
