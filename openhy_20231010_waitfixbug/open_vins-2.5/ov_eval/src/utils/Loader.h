...
public:
  ...
  /**
   * @brief Will diverse poses to seg
   * @param poses Pose at every timestep [pos,quat]
   * @param length Seg length
   * @param poses_seg Seg
   */
  static void pose_seg_by_length(const std::vector<double> &times_gt,const std::vector<double> &times_esi,
