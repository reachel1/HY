...
// #include "../include/GeometricTools.h"
...
{
    std::unique_lock<std::mutex> lock(mMutex);
    // std::cout<< "JRg*db.head(3)"<<std::endl;
    // std::cout<< JRg*db.head(3) <<std::endl;
